...
INSERT INTO `categories` (`id`, `name`, `description`, `status`, `service_link`, `created_at`) VALUES
(1, 'Hair Products', 'Products related to hair care.', 'Active', 'https://example.com/hair-products', '2025-03-05 05:20:04'),
(2, 'Body and Relaxing Products', 'Products for body care and relaxation.', 'Active', 'https://example.com/body-products', '2025-03-05 05:20:04'),
(3, 'Diode Laser Products', 'Products for diode laser treatments.', 'Active', 'https://example.com/laser-products', '2025-03-05 05:20:04'),
(4, 'Nails and Foot Services', 'Services for nails and foot care.', 'Active', 'https://example.com/nails-services', '2025-03-05 05:20:04');
...
(14, 'Head & Shoulders', 'Hair Product', 'Hair Services', 4, '', '', 4.00, 'Unilab');
...
INSERT INTO `price_list` (`id`, `name`, `details`, `description`) VALUES
(1, 'Membership Discount', '20% Markdown', 'For loyal customers'),
(2, 'Holiday Discount', '10% Markdown', 'Seasonal discounts');
...
(1, 'Hair Services', 'https://example.com/hair-services'),
(2, 'Body Services', 'https://example.com/body-services'),
(3, 'Laser Services', 'https://example.com/laser-services'),
(4, 'Nail Services', 'https://example.com/nail-services');
...
(5, 'wanna@gmail.com', '$2y$10$swl/yKsANuRIbPu3J22HV.ay6NLGxafAJjP.upDgClNPU68ru22E2', 'customer', '2025-03-06 04:29:09', NULL);
